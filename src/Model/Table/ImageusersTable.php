 ...
 *
 * @method \App\Model\Entity\Imageuser get($primaryKey, $options = [])
 * @method \App\Model\Entity\Imageuser newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\Imageuser[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\Imageuser|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Imageuser|bool saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
